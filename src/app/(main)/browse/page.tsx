...
export default function BrowsePage() {
  ...
  return (
    <div className="space-y-8">
      <h1 className="text-4xl font-bold font-headline">Parcourir les Articles (Ultra Basit Test)</h1>
      <p>Eğer bu sayfayı görüyorsanız, /browse rotası temel olarak çalışıyor demektir.</p>
