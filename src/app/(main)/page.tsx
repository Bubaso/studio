    ...
    <div className="space-y-12 md:space-y-16">
      ...
      <section className="text-center py-12 md:py-20 bg-gradient-to-br from-card to-background rounded-xl shadow-xl overflow-hidden">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold font-headline text-primary mb-4">
      ...
      <section className="py-12 md:py-16 bg-card rounded-xl shadow-lg">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl md:text-3xl font-bold font-headline text-center mb-10">Comment ça marche ?</h2>
          <div className="grid md:grid-cols-3 gap-6 md:gap-8 text-center">
            <div className="p-6 border border-border/50 rounded-lg hover:shadow-xl transition-shadow bg-background">
              ...
              <h3 className="text-xl font-semibold mb-2 font-headline">1. Découvrez</h3>
            ...
            <div className="p-6 border border-border/50 rounded-lg hover:shadow-xl transition-shadow bg-background">
              ...
              <h3 className="text-xl font-semibold mb-2 font-headline">2. Vendez Facilement</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
            ...
            <div className="p-6 border border-border/50 rounded-lg hover:shadow-xl transition-shadow bg-background">
              ...
              <h3 className="text-xl font-semibold mb-2 font-headline">3. Connectez-vous</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
